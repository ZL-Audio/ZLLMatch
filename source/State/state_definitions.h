...
namespace zlstate {
    ...
    public:
        ...
        auto static constexpr name = "NA";
        inline static const int minV = 138;
        inline static const int maxV = 2758;
        inline static const int defaultV = 276;
        inline auto static const range =
                juce::NormalisableRange<float>(minV, maxV, 1.f);
    };
    ...
    public:
        ...
        auto static constexpr name = "NA";
        inline static const int minV = 87;
        inline static const int maxV = 1733;
        inline static const int defaultV = 173;
        inline auto static const range =
                juce::NormalisableRange<float>(minV, maxV, 1.f);
    };
